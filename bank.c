//USE VSCODE OR DEVC++ OR CODEBLOCKS TO SUPPORT PACKAGES IN C
//header files
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
...
struct tree* search(struct tree* root, long search_accno){
	if (root == NULL || root->acc_no == search_accno) return root;
	if (root->acc_no < search_accno) return search(root->right, search_accno);
	return search(root->left, search_accno);
}
...
int main(){
  ...
  do{
    system("cls");
    printf("\033[0;37m");
    printf("\tBANK TRANSACTION MANAGEMENT\n");
    ...
    printf("\n\xB2 %-46s \xB2","5. MAKE A TRANSACTION.");
    printf("\n\xB2 %-46s \xB2","6. WITHDRAW AMOUNT.");
    printf("\n\xB2 %-46s \xB2","7. DEPOSIT AMOUNT.");
    printf("\n\xB2 %-46s \xB2","8. DISPLAY ALL TRANSACTIONS.");
    printf("\n\xB2 %-46s \xB2","9. SAVE ALL CHANGES TO THE FILE.");
    printf("\n\xB2 %-46s \xB2","10. DISPLAY ALL THE  ACCOUNT DETAILS.");
    printf("\n\xB2 %-46s \xB2","11. EXIT.");
    printf("%-46s","\n\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
    printf("\033[0m");
    printf("\n\nEnter your choice:");
